...
@RestController
@RequestMapping("/api/rest/curso1")
public class CursoController {
	...
	public ResponseEntity<List<Curso>> listaPorCodigo(@PathVariable String filtro){
		return ResponseEntity.ok(service.listaCursoPorCodigo(filtro));
	}
}
